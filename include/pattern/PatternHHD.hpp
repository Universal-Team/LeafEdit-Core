...
#ifndef _LEAFEDIT_CORE_PATTERN_HHD_HPP
#define _LEAFEDIT_CORE_PATTERN_HHD_HPP

#include "Pattern.hpp"
#include "PatternImageNL.hpp" // NL & HHD are the same, anyways.
#include "Player.hpp"
...
public:
	virtual ~PatternHHD() { }
	PatternHHD(std::shared_ptr<u8[]> patternData, u32 offset) :
