...
#ifndef _LEAFEDIT_CORE_ITEM_WHITELIST_WA_HPP
#define _LEAFEDIT_CORE_ITEM_WHITELIST_WA_HPP

#include "itemKindWA.hpp"
#include "ItemWhiteList.hpp"
#include "types.hpp"

class ItemWhiteListWA : public ItemWhiteList {
public:
	...
	std::unique_ptr<ItemKind> GetItemKind() const override { return std::make_unique<ItemKindWA>(); };
};
