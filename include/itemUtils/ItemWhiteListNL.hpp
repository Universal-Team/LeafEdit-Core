...
#ifndef _LEAFEDIT_CORE_ITEM_WHITELIST_NL_HPP
#define _LEAFEDIT_CORE_ITEM_WHITELIST_NL_HPP

#include "itemKindNL.hpp"
#include "ItemWhiteList.hpp"
#include "types.hpp"

class ItemWhiteListNL : public ItemWhiteList {
public:
	...
	std::unique_ptr<ItemKind> GetItemKind() const override { return std::make_unique<ItemKindNL>(); };
};
